...
def main():
	temp_dividend = 10
	train_batch_size = 2 ** 20 // temp_dividend
	test_batch_size = 2 ** 20 // temp_dividend
	sequence_length = 20
	num_hidden = 16
	input_dim = 1
	...
	with tf.Session() as sess:
		...
		sess.run(output_t, feed_dict={train_input_t: train_input_d, test_input_t: test_input_d})
